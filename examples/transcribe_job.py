...
Any supported input works here: a YouTube, TikTok or Instagram URL, or a
direct media file URL. When captions exist the first call already returns the
text; when they do not, the API transcribes the audio and hands back a job to
poll. Polling is free, so the loop below costs at most the one credit on delivery.
"""
